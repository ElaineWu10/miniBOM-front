Version:0.9 StartHTML:0000000105 EndHTML:0000128771 StartFragment:0000000141
EndFragment:0000128735
<template>
   
  <div>
       
    ...
    <el-form :inline="true" :model="queryForm" class="demo-form-inline">
      ...
      <el-form-item>
               
        <el-button type="primary" @click="hanldeSearch(1)" icon="el-icon-search"
          >查询</el-button
        >
             
      </el-form-item>
      ...
      <el-form-item>
               
        <el-button type="primary" @click="resetSearch" icon="el-icon-refresh"
          >重置</el-button
        >
             
      </el-form-item>
      ...
      <el-form-item>
               
        <el-button type="success" @click="addAttr" icon="el-icon-edit"
          >新增</el-button
        >
             
      </el-form-item>
  ...
  methods: {
    ...
    hanldeSearch(num) {
      ...
      if (this.queryForm.name === "") {
        ...
        this.$axios({
          method: "post",
          url: `/exaDefinition/findByName/${this.queryForm.name}`, // data: { //   name: this.queryForm.name, // },
        }).then((res) => {
          this.tableDatalist = res.data.data;
          this.queryForm.total = res.data.data.length;
          this.tableData = res.data.data.slice(
